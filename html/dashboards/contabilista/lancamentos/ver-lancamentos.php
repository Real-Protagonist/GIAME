    ...
    <div class="flex flex-col flex-1 main-content">
      ...
      <main class="flex-1 overflow-auto">
        <div class=" page-content">
          <h1 class="text-3xl font-semibold text-transparent bg-gradient-to-r from-primary to-secondary bg-clip-text">
            Lançamentos Efetuados
          </h1>

          <div class="flex flex-col gap-2">
            <!-- Search + Registrar -->
            <div class="flex flex-wrap items-center justify-between mb- gap-">
              <!-- Search Input -->
              ...
              <!--button
                ...
                onclick="window.location.href='criar-lancamentos.html'">
