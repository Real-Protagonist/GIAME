    ...
    <div class="flex flex-col flex-1 main-content">
      ...
      <main class="flex-1 overflow-auto bg-gray-50">
        <div class="mx-auto space-y-4 page-content">
          ...
          <section class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div class="p-6 transition-all bg-white border border-gray-200 shadow-sm rounded-2xl hover:shadow-md group">
              <div class="flex items-center justify-between mb-4">
                ...
                <a href="clientes/ver-clientes.html"
                  class="flex items-center gap-1 text-sm text-gray-400 transition hover:text-secondary">
                  Ver <i data-lucide="arrow-right" class="w-4 h-4"></i>
                </a>
              </div>
              <p class="text-gray-500">Clientes Cadastrados</p>
              <div class="grid grid-cols-2 mt-2 text-sm text-gray-700 gap-y-1">
                <p>Singulares: <strong>2</strong></p>
            ...
            <div class="p-6 transition-all bg-white border border-gray-200 shadow-sm rounded-2xl hover:shadow-md group">
              <div class="flex items-center justify-between mb-4">
                <div class="bg-primary/10 text-primary p-2.5 rounded-xl group-hover:scale-105 transition">
                  <i data-lucide="building2" class="w-5 h-5"></i>
                </div>
                <a href="clientes/sector-empresas.html"
                  class="flex items-center gap-1 text-sm text-gray-400 transition hover:text-secondary">
                  Ver <i data-lucide="arrow-right" class="w-4 h-4"></i>
                </a>
              </div>
          ...
          <!-- Ações Rápidas -->
          <section class="mt-8">
            <h3 class="mb-4 text-lg font-semibold text-gray-700">Ações Rápidas</h3>
            <div class="grid grid-cols-2 gap-4 md:grid-cols-2">
              <!-- Novo cliente -->
              <a href="clientes/adicionar-cliente.html"
                ...
                <p class="text-sm text-gray-700">Adicionar Cliente</p>
              </a>
